# Budget ledger — hard cap $50

| Date | Item | Cost | Running total |
|---|---|---|---|
| 2026-08-08 | M0: local preview (Node http-server + Playwright, all free/open-source) | $0.00 | $0.00 |
| 2026-08-08 | M1: Supabase backend (free tier — schema, secrets, 2 edge functions) | $0.00 | $0.00 |
